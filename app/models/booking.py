...
from sqlalchemy import (
    String, ForeignKey, Enum as SQLEnum, DateTime, Numeric, 
    Text, CheckConstraint, Index, Integer, Date
)
...
class Booking(BaseModel):
    ...
    __table_args__ = (
        CheckConstraint(
            "total_amount >= 0",
            name="ck_booking_total_amount_non_negative"
        ),
        CheckConstraint(
            "service_fee >= 0",
            name="ck_booking_service_fee_non_negative"
        ),
        CheckConstraint(
            "discount_amount >= 0",
            name="ck_booking_discount_non_negative"
        ),
